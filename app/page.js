...
function Footer() {
  return (
    <footer style={{ background: ACCENT, padding: '48px 24px 32px' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 32, marginBottom: 40 }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
              <img src="/images/Logo/bfc_logo.png" alt="BFC Flensburg" style={{ height: 48, width: 48, objectFit: 'contain', filter: 'brightness(0) invert(1)' }} />
              <div style={{ fontFamily: "var(--font-display)", fontSize: 22, fontWeight: 700, color: 'white' }}>BFC <span style={{ color: BLUE }}>Flensburg</span></div>
            </div>
            <div style={{ fontSize: 14, color: 'rgba(255,255,255,0.5)', maxWidth: 300, lineHeight: 1.5 }}>Business and Finance Club Flensburg e.V.<br />Kanzleistr. 91–93 · 24943 Flensburg</div>
          </div>
          <div style={{ display: 'flex', gap: 32, flexWrap: 'wrap' }}>
            <div>
              <div style={{ fontSize: 12, fontWeight: 700, color: BLUE, letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 12 }}>Links</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <a href="#ueber" style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)' }}>Über uns</a>
                <a href="#vorteile" style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)' }}>Vorteile</a>
                <a href="#events" style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)' }}>Events</a>
                <Link href="/team" style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)' }}>Das Team</Link>
                <a href="https://www.bvh.org" target="_blank" rel="noopener noreferrer" style={{ fontSize: 14, color: 'rgba(255,255,255,0.6)' }}>BVH ↗</a>
              </div>
            </div>
            <div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 20, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>© {new Date().getFullYear()} Business and Finance Club Flensburg e.V.</div>
          <div style={{ display: 'flex', gap: 20 }}>
            <Link href="/datenschutz" style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>Datenschutz</Link>
            <Link href="/impressum" style={{ fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>Impressum</Link>
          </div>
        </div>
      </div>
    </footer>
